...
struct VersionResult: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case supportedDevices, advisories, isGameCenterEnabled, kind, features, trackCensoredName, languageCodesISO2A, fileSizeBytes, contentAdvisoryRating, averageUserRatingForCurrentVersion, userRatingCountForCurrentVersion, averageUserRating
        case trackViewURL = "trackViewUrl"
        case trackContentRating
        case trackID = "trackId"
        case trackName, releaseDate
        case genreIDS = "genreIds"
        case formattedPrice, primaryGenreName, isVppDeviceBasedLicensingEnabled
